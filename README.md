...
# :warning: Discontinued (kinda)
I have plans to rebuild this project to use .NET Core and AvaloniaUI as the UI framework. I have no clue when I will start on this, guess only time will tell.
